...
?>
	<h4>[投稿フォーム]</h4>
	名前:　　　　<input type="text" name="name" placeholder="名前を入力してください" value="<?php echo @$box1; ?>"><br>
	コメント:　　<input type="text" name="comment" placeholder="コメントを入力してください" value="<?php echo @$box2; ?>"><br>
	パスワード:　<input type="text" name="password1" placeholder="パスワードを入力してください"><br>
	<input type="submit" name="button_submit" value="送信"><br><br>

	<h4>[削除フォーム]</h4>
	投稿番号:　　<input type="text" name="delete" placeholder="投稿番号を入力してください"><br>
	パスワード:　<input type="text" name="password2" placeholder="パスワードを入力してください"><br>
	<input type="submit" value="送信"><br><br>

	<h4>[編集フォーム]</h4>
	投稿番号:　　<input type="text" name="edit" placeholder="投稿番号を入力してください"><br>
	パスワード:　<input type="text" name="password3" placeholder="パスワードを入力してください"><br>
